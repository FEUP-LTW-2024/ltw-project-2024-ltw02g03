...
CREATE TABLE Items (
    ...
    FOREIGN KEY (CategoryID) REFERENCES ProductCategories(CategoryID) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
INSERT INTO Users (FirstName, LastName, Username, Email, Password, JoinDate)
VALUES ('John', 'Doe', 'johndoe', 'johndoe@example.com', 'password123', '2024-01-01');

INSERT INTO Users (FirstName, LastName, Username, Email, Password, JoinDate)
VALUES ('Jane', 'Smith', 'janesmith', 'janesmith@example.com', 'password456', '2024-01-02');
...
-- Inserir items de exemplo
INSERT INTO Items (SellerID, CategoryID, Title, Description, Price, Condition, ListingDate)
VALUES (1, 1, 'Smartphone', 'Smartphone em ótimo estado', 500.00, 'Usado', '2024-01-03');

INSERT INTO Items (SellerID, CategoryID, Title, Description, Price, Condition, ListingDate)
VALUES (2, 2, 'Camiseta', 'Camiseta nova com etiqueta', 20.00, 'Novo', '2024-01-04');

-- Inserir transações de exemplo
INSERT INTO Transactions (BuyerID, SellerID, ItemID, TransactionDate)
VALUES (2, 1, 1, '2024-01-05');

INSERT INTO Transactions (BuyerID, SellerID, ItemID, TransactionDate)
VALUES (1, 2, 2, '2024-01-06');

-- Inserir mensagens de exemplo
INSERT INTO Messages (SenderID, ReceiverID, MessageText, SendDate)
VALUES (1, 2, 'Olá, estou interessado na sua camiseta.', '2024-01-07');

INSERT INTO Messages (SenderID, ReceiverID, MessageText, SendDate)
VALUES (2, 1, 'Olá, obrigado pelo interesse. Estou disponível para responder suas perguntas.', '2024-01-08');

-- Inserir itens no carrinho de compras de exemplo
INSERT INTO ShoppingCart (UserID, ItemID, Quantity)
VALUES (1, 1, 1);
